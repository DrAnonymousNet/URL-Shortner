...
class TestBaseView(APITestCase):
    def setUp(self) -> None:
        ...
        self.link_1 = Link.objects.create(
            long_link="https://stackoverflow.com/questions/23467032/how-to-set-up-load-balancing-with-nginx-and-gunicorn",
            owner=self.user)
        self.link_2 = Link.objects.create(
            long_link="https://chat.whatsapp.com/I6P6T9T3Oev3v6LJN6Fc7W")
